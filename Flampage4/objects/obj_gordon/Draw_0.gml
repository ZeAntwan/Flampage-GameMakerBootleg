...
draw_text(x+sprite_width/2,y-110,"gordon")
draw_self();
...
if (!attackMode) {
	if(direction<45 or direction>315) {
		...
		if(direction<45 or direction>315) {
		//Right Direction
			sprite_index = spr_gordon_atk_r;
		}
		else if (direction<315 and direction>225) {
		//Bottom Direction
			sprite_index = spr_gordon_atk_b;
		}
		else if (direction>45 and direction<225 and direction>135 and direction<315) {
		//Left Direction
			sprite_index = spr_gordon_atk_l;
		}
		else if (direction<135 and direction>45) {
		//Top Direction
			sprite_index = spr_gordon_atk_t;
		}
}
draw_self();